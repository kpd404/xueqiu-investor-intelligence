...
class InvestorBehaviorSnapshotService:
    ...
    def calculate(
        ...
        with self._unit_of_work_factory() as unit_of_work:
            attention_history = unit_of_work.attention_occurrences.list_effective_by_investor(
                investor_id,
            ...
            portfolio_actions = self._within(
                unit_of_work.portfolio_actions.list_by_investor(investor_id),
                normalized_start,
                normalized_end,
                time_getter=lambda item: item.effective_time,
            )
            consistencies = self._within(
                unit_of_work.consistencies.list_by_investor(
                    investor_id,
